...
function [data_out, index_sample_out,end_file] = read_gr_complex_binary_ma(fileName, index_sample_in, num_samples_block)

number_bytes_per_complex_sample   = 16;
...
if ~feof(fid)
    ...
    [data, count] = fread(fid, [2, num_samples_block], 'double');
