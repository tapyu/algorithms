...
function [data_out, index_sample_out,end_file] = read_gr_complex_binary_old (fileName, index_sample_in, num_samples_block)
...
%read end of file
fseek(fid, 0, 'eof');
end_of_file_samples=ftell(fid)/number_bytes_per_complex_sample;

if offset < end_of_file_samples
end_file=0;
